...
bool SvgaResource::_load2_x(const std::wstring& path)
{
	...
	std::ifstream input;
        input.open(WstringToString(path.c_str()), std::ifstream::in | std::ifstream::binary);
...
std::wstring SvgaResource::StringToWstring(const std::string str)
{// string转wstring
...
std::string SvgaResource::WstringToString(const std::wstring str)
{// wstring转string
